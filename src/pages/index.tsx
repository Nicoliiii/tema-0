    ...
    <main className='h-full bg-main-100 text-main-700'>
      <section id='hero' className='bg-theme-500'>
        <div className='wrapper text-center text-main-100 fill-main-100 max-w-md'>
          ...
          <h1 className='my-6'>
            Hi, I'm Nicoli, another fine little freebie from <a href="TODO:">UTFPR</a>.
          </h1>
      ...
      <section id='intro'>
        <div className='wrapper grid sm:grid-cols-2 gap-10 text-center'>
          <h2 className='text-left'>Lorem ipsum dolor adipiscing <br/> amet dolor consequat</h2>
          <img src='/imagem.jpg' className='aspect-video object-cover'/>
        </div>
      </section>
      <section id='cards'>
        <div className='wrapper text-center'>
          <h2>Adipiscing amet consequat</h2>
          <p className='mb-6'>Ante nunc accumsan et aclacus nascetur ac ante amet sapien sed.</p>
      ...
      <section id='signup' className='bg-main-700 text-main-100'>
        <div className='wrapper text-center flex flex-col'>
          ...
          <p className='mb-6'>Sed lacus nascetur ac ante amet sapien</p>
